...
namespace MLProject
{
    ...
    {
        public const string RetrainFilePath =  @"D:\School\Jaar3\Sem1\SoftwareTrends\Project\MLProject\MLProject\SentimentFiles\AllSentiments.txt";
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.Text.FeaturizeText(inputColumnName:@"col0",outputColumnName:@"col0")      
                                    ...
                                    .Append(mlContext.MulticlassClassification.Trainers.OneVersusAll(binaryEstimator:mlContext.BinaryClassification.Trainers.FastTree(new FastTreeBinaryTrainer.Options(){NumberOfLeaves=55,MinimumExampleCountPerLeaf=2,NumberOfTrees=431,MaximumBinCountPerFeature=42,FeatureFraction=0.48065204778877,LearningRate=0.999999776672986,LabelColumnName=@"col1",FeatureColumnName=@"Features",DiskTranspose=false}),labelColumnName: @"col1"))      
